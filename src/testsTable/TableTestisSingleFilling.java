...
class TableTestisSingleFilling {
	...
	void test2() {
		...
		boolean actual = tableTeste.singleFilling(0);
	...
	void test3() {
		...
		boolean actual = tableTeste.singleFilling(2);
		boolean expected = true;
	...
	void test4() {
		...
		boolean actual = tableTeste.singleFilling(5);
		boolean expected = true;
